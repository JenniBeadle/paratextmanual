...
ECHO 4 - French Manual version 9.2
ECHO . 
...
npx docu-pdf http://localhost:3000/9.2/fr/Training-Manual/Overview --coverPath="cover-man-fr.html"  --contentSelector="article" --pageSize="A5" --outputPath="Ptx-man-a5-9.2.fr.pdf" --disableTOC --headerTemplate="<header><div style='width: 100 10px; margin: 1cm; color: #bbb; height: 30px; text-align: right;'><span class='URL'</span></div></header>"  
IF "%X%"== "1" GOTO :EOF
GOTO MENU
