...
You will start the Paratext 9 program and open a previously saved layout (text combination). If needed you will open other Fresources, change the arrangement of the windows and resave the text layout.
