...
|  |  |
|--|--|
| **From the video** | Like editing other books in Paratext, it is necessary for a user to have the relevant _task assignments_ or _user permissions_ in order to add renderings to the glossary or to edit the glossary book directly.|
| **Permissions** | User permission to GLO
|  | gif |
| **Tasks** |     Stage 2: Draft supplementary material | 
...
The Scripture Reference Settings dialog can be viewed by users but there are several settings required administrtors permission.
...
From '5.3 Install resources – files'
