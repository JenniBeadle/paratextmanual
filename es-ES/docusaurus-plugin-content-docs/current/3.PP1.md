...
1.  Cerrar la lista de resultados. (Si desea cerrar la lista).
1.  **≡ Menú de Paratext** bajo **Paratext** \> **Guardar todo** (o **Ctrl**+**s**).
1.  Volver a Asignaciones y progreso.

:::consejo 
La verificación se considera completa con 0 incidencias. Si no puede completar una verificación, es posible posponerla para una etapa posterior.
:::
