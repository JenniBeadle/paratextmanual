...
npx docu-pdf https://manual.paratext.org/Training-Manual/Overview --coverPath="cover-man-en.html"  --contentSelector="article" --pageSize="A5" --outputPath="Ptx-man-a5-en-9.3.pdf" --disableTOC --headerTemplate="<footer />" --pdfMargin="40,40,80,40" --excludeURLs="https://manual.paratext.org/category/paratext-training-manual,https://manual.paratext.org/category/appendix"
...
npx docu-pdf https://manual.paratext.org/Video-summaries/TOC-overview --coverPath="cover-vidsum-en.html"  --contentSelector="article" --pageSize="A5" --outputPath="Ptx-vidsum-a5-en-9.3.pdf" --disableTOC --headerTemplate="<footer />" --pdfMargin="40,40,80,40" --excludeURLs="@excludesENvid.txt"
IF "%X%"== "1" GOTO :EOF
GOTO MENU
