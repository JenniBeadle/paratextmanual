...
**തുടങ്ങുന്നതിനു മുമ്പ്:** താങ്കൾ നിലവിലുള്ള ഒരു പ്രൊജക്റ്റിലേയ്ക്ക് റ്റൈപ്പ് ചെയ്യാനൊരുങ്ങുകയാണ്. Before you can do this, someone must have already installed the program, created a project for your data and installed resources for you.
